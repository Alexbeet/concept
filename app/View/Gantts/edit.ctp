...
<?php echo $this->Form->create('Gantt'); ?>
	<fieldset>
		<legend><?php echo __('Edit Gantt'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Gantt.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Gantt.id'))); ?></li>
